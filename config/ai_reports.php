...
return [
    ...
    | Laravel\Ai\Enums\Lab case); a Flash-tier model is plenty for summarising a
    | handful of pre-computed figures. See the README "AI Provider" section for
    | the shared AI_PROVIDER switch.
    |
    */

...
/**
 * Served even while the medals are switched off, rather than hiding itself. A
 * tool that vanishes leaves an agent with no way to say why, and "not enabled
 * for this account" is a better answer to "what medals do I have?" than a
 * catalog that quietly lacks the word.
 */
#[IsReadOnly]

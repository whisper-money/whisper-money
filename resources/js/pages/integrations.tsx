...
import { type ComparisonLabels } from '@/types/comparison';
import {
...
function CountryGroup({ country }: { country: IntegrationsCountry }) {
    return (
        <section className="flex flex-col gap-3">
            ...
            <ul className="grid gap-x-6 gap-y-1 text-sm text-[#706f6c] sm:grid-cols-2 lg:grid-cols-3 dark:text-[#A1A09A]">
        ...
        return countries
            .map((country) => ({
                ...
                banks: country.banks.filter((bank) =>
                    searchable(bank).includes(needle),
                ),
            }))
                ...
                <main className="mx-auto flex w-full max-w-3xl flex-col gap-12 px-6 pt-28 pb-12 lg:pt-32 lg:pb-16">
                    ...
                    <section className="flex flex-col gap-4">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <p
                                aria-live="polite"
                                className="text-xs text-[#706f6c] dark:text-[#A1A09A]"
                            >

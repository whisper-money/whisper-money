...
{{ __("Hi! It's Víctor and Álvaro, the founders of Whisper Money. A quick heads-up so nothing catches you by surprise: your free trial ends on :date, and we'll charge :amount to the card you signed up with.", ['date' => $trialEndsAt->isoFormat('LL'), 'amount' => $amount]) }}
...
{{ __('That link takes you to your billing details, where you can change the card or cancel. Cancel before :date and you will not be charged anything at all.', ['date' => $trialEndsAt->isoFormat('LL')]) }}

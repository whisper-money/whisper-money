{{-- For users who cancelled but are still inside their paid period and are on
     the low price. The --audience filter leaves out the A/B cohort already on
     the high price, who have nothing to lose here. Send it with exactly this
     subject, which doubles as the lang/es.json key, or Spanish readers get an
     English subject:

     php artisan email:update price-increase-cancelling-sep-2026 --audience=cancelling-low-price --subject="If your subscription ends, you lose the €3.99 price" --exclude-demo --}}
<x-mail::message>
...
{{ __('I am here because something changes on Monday that I will not be able to undo for you later.') }}

{{ __('On Monday 21 September the price goes up.') }}
...
{{ __('Coming back later means the new price: €8.99 a month, or €53.94 a year. It applies to everyone who subscribes after Sunday 20 September at 23:59 CEST.') }}
